...
import static utils.messages.PersonPageErrorMessages.EMPTY_PATIENT_FIRST_NAME;
import static utils.messages.PersonPageErrorMessages.EMPTY_PATIENT_LAST_NAME;
import static utils.messages.PersonPageErrorMessages.EMPTY_PATIENT_SOCIAL_NUMBER;
import static utils.messages.PersonPageErrorMessages.EMPTY_RESPONDENT_FIRST_NAME;
import static utils.messages.PersonPageErrorMessages.EMPTY_RESPONDENT_LAST_NAME;
import static utils.messages.PersonPageErrorMessages.INVALID_PATIENT_EMAIL;
import static utils.messages.PersonPageErrorMessages.INVALID_PATIENT_FIRST_NAME;
import static utils.messages.PersonPageErrorMessages.INVALID_PATIENT_LAST_NAME;
import static utils.messages.PersonPageErrorMessages.INVALID_PATIENT_SOCIAL_NUMBER;
import static utils.messages.PersonPageErrorMessages.INVALID_PATIENT_TELEPHONE;
import static utils.messages.PersonPageErrorMessages.INVALID_RESPONDENT_FIRST_NAME;
import static utils.messages.PersonPageErrorMessages.INVALID_RESPONDENT_LAST_NAME;
import static utils.messages.PersonPageErrorMessages.SHORT_LONG_PATIENT_TELEPHONE;
import static utils.messages.PersonPageErrorMessages.SHORT_PATIENT_FIRST_NAME;
import static utils.messages.PersonPageErrorMessages.SHORT_PATIENT_LAST_NAME;
import static utils.messages.PersonPageErrorMessages.SHORT_RESPONDENT_FIRST_NAME;
import static utils.messages.PersonPageErrorMessages.SHORT_RESPONDENT_LAST_NAME;
